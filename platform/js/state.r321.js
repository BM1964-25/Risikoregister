export const initialState = {
  ...
  monteCarlo: {
    ...
    formulaNote: "Die Formel verarbeitet die aktiven Variablen in der Reihenfolge ihrer Schlüssel. Erlaubt sind einfache Rechenzeichen und Math-Funktionen.",
    scenarioMode: "realistic",
    scenarioNote: "Szenarien werden als gespeicherte Modellstände geführt und können als Baseline oder Variante verglichen werden.",
    correlationNote: "Korrelationsgruppen können dokumentiert werden, damit zusammenhängende Einflüsse später modellseitig verknüpft werden können.",
    variables: [
      {
        id: "mc-v1",
        key: "basis",
        name: "Basiswert",
        description: "Grundlage des Zielwerts",
        unit: "€",
        distribution: "normal",
        minimum: 17000000,
        likely: 18500000,
        ...
        stdDev: 500000,
        active: true,
        source: "Projektbudget"
      },
      {
        id: "mc-v2",
        key: "material",
        name: "Materialkosten",
        description: "Preis- und Mengenrisiken im Material",
        unit: "€",
        distribution: "pert",
        minimum: 1400000,
        likely: 2100000,
        ...
        stdDev: 0,
        active: true,
        source: "Marktannahmen"
      },
      {
        id: "mc-v3",
        key: "personal",
        name: "Personalkosten",
        description: "Leistung und Produktivität",
        unit: "€",
      ...
      },
      {
        ...
        key: "risiko",
        name: "Risikopuffer",
        description: "Zusätzlicher Unsicherheitsaufschlag",
        unit: "€",
        ...
        stdDev: 0,
        active: true,
        source: "Risikoregister"
      }
    ],
    workPackages: [],
    riskEvents: [
      { id: "mc-r1", name: "Schlechtwetterphase", probability: 0.3, minCostImpact: 8000, maxCostImpact: 35000, minDelayDays: 5, maxDelayDays: 20, active: true },
      { id: "mc-r2", name: "Materialpreissteigerung", probability: 0.25, minCostImpact: 20000, maxCostImpact: 90000, minDelayDays: 0, maxDelayDays: 7, active: true }
    ],
