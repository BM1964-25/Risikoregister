...
function normalizeRiskRegisterPanelOrder(panelOrder) {
  ...
  const merged = [...new Set([...filtered, ...defaultOrder])];
  return defaultOrder.filter((value) => merged.includes(value));
}
