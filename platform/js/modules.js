import { initialState } from "./state.js?v=eva-final-267";
      ...
      return `
        <div class="module-shell risk-register-shell">
          ...
          <details class="info-card risk-fold-card ai-workshop-card" open style="margin-top:18px;">
            ...
            <p class="form-note">Wenn du ein neues Risiko erfasst, legst du es direkt an. Für Maßnahmenvorschläge wählst du oben ein Zielrisiko und übernimmst dann gezielt in dieses Risiko.</p>
            ...
            <p class="form-note" style="margin-top:8px;">Mit den Buttons übernimmst du die KI-Vorschläge nach Prüfung in das Risikoregister.</p>
            </div>
          </details>
