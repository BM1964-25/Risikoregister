import { createStore, cloneState } from "./state.r292.js";
import { modules, riskCategoryOptions, normalizeRiskCategoryValue, calculatePertResult, calculateMonteCarloResult, calculateEarnedValueResult, buildManagementReportData, buildSelectedReportData, renderSelectedReportText, renderRiskReportText } from "./modules.r292.js";
...
async function runAiWorkshopTask(task) {
  ...
  try {
    ...
    const parsedResult = sanitizeAiWorkshopResult(
