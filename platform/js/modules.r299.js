import { initialState } from "./state.r299.js";
        ...
        <div class="module-shell risk-register-shell">
          ...
          <details class="info-card risk-fold-card ai-workshop-card" open style="margin-top:18px;">
            ...
            <div class="ai-workshop-result-actions" style="margin-top:12px;">
              <button class="action-btn primary" type="button" data-action="apply-ai-workshop-result" ${state.ui?.aiWorkshop?.activeTask === "measures-residual" && !String(state.ui?.aiWorkshop?.selectedRiskId || "").trim() ? "disabled" : ""}>${String(state.ui?.aiWorkshop?.selectedRiskId || "").trim() ? "Bestehendes Risiko aktualisieren" : (state.ui?.aiWorkshop?.activeTask === "measures-residual" ? "Neues Risiko anlegen" : "Neues Risiko anlegen")}</button>
