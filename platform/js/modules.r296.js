      ...
      return `
        <div class="module-shell risk-register-shell">
          ...
          <details class="info-card risk-register-card risk-fold-card risk-fold-edit" open>
            ...
            <div class="risk-fold-body">
              <div style="margin-bottom:14px; display:flex; flex-wrap:wrap; gap:10px;">
                ...
                <button class="action-btn" type="button" data-action="undo-risk-register-change" ${riskUndoCount > 0 ? "" : "disabled"}>Letzten Schritt rückgängig</button>
              </div>
