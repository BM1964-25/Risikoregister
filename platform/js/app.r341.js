...
function bindEvents() {
  ...
  document.addEventListener("pointerup", (event) => {
    ...
    const panel = targetElement?.closest?.("[data-risk-panel-key]");
    if (!panel) {
