        ...
        <div class="module-shell risk-register-shell">
          ...
          <details class="info-card risk-fold-card ai-workshop-card" open style="margin-top:18px;">
            ...
            <div class="form-field wide">
                ...
                <textarea id="aiWorkshopFreeText" data-ai-workshop-field="freeText" placeholder="Beschreibe ein Risiko, eine Maßnahme oder einen Sachverhalt, den die KI strukturieren soll. Beachte: Je ausführlicher du formulierst, desto besser kann die KI ein Ergebnis erstellen.">${escapeHtml(state.ui?.aiWorkshop?.freeText || "")}</textarea>
              </div>
            </div>
