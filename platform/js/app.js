import { createStore, cloneState } from "./state.js?v=eva-final-267";
import { modules, calculatePertResult, calculateMonteCarloResult, calculateEarnedValueResult, buildManagementReportData, buildSelectedReportData, renderSelectedReportText, renderRiskReportText } from "./modules.js?v=eva-final-267";
      ...
      items: [
        {
          ...
          category: selectedRisk?.category || "Operativ",
...
function mapSuggestedRiskToRegisterItem(suggestion = {}, fallbackId = "") {
  ...
  return {
    ...
    category: String(suggestion.category || "Operativ").trim() || "Operativ",
    area: "",
