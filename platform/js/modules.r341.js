import { initialState } from "./state.r338.js";
...
export const modules = {
  ...
  riskRegister: {
    ...
    render(state) {
      ...
      const panelOrderIndex = (key) => Math.max(0, panelOrder.indexOf(key));
      const panelOpenStates = riskView.panelOpenStates && typeof riskView.panelOpenStates === "object" ? riskView.panelOpenStates : {};
      const isPanelOpen = (key) => panelOpenStates[key] !== false;
      ...
      const topSortBy = ["priority", "value"].includes(riskView.topSortBy) ? riskView.topSortBy : "priority";
      ...
      const topSortedRisks = [...visibleRiskRows].sort((a, b) => {
        if (topSortBy === "value") {
          return b.expectedDamage - a.expectedDamage || b.qualitativeRiskValue - a.qualitativeRiskValue;
        }
        const todayTs = parseRiskDateValue(new Date().toISOString().slice(0, 10));
      ...
      const topRisks = topLimit === 0 ? topSortedRisks : topSortedRisks.slice(0, topLimit);
      const topMetricMax = Math.max(...topRisks.map((risk) => topSortBy === "value" ? risk.expectedDamage : risk.qualitativeRiskValue), 1);
      return `
        <div class="module-shell risk-register-shell">
          ...
          <div class="risk-register-panel-bar">
            <button class="action-btn" type="button" data-action="close-risk-register-panels">Alle Tafeln schließen</button>
          </div>
          <div class="risk-register-panels">
          <details class="info-card risk-register-card risk-fold-card" data-risk-panel-key="overview" style="order:${panelOrderIndex("overview")};" ${isPanelOpen("overview") ? "open" : ""}>
            <summary class="risk-fold-summary">
              <div class="risk-fold-summary-main">
                <div class="risk-fold-summary-topline">
                  <span class="risk-fold-drag-handle" data-risk-panel-drag-handle="true" draggable="true" aria-hidden="true"><svg viewBox="0 0 18 14" role="presentation" focusable="false"><path d="M2 3.5h14M2 7h14M2 10.5h14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg></span>
          ...
          <details class="info-card risk-register-card risk-fold-card ai-workshop-card" data-risk-panel-key="ai" style="order:${panelOrderIndex("ai")};" ${isPanelOpen("ai") ? "open" : ""}>
            <summary class="risk-fold-summary">
              <div class="risk-fold-summary-main">
                <div class="risk-fold-summary-topline">
                  <span class="risk-fold-drag-handle" data-risk-panel-drag-handle="true" draggable="true" aria-hidden="true"><svg viewBox="0 0 18 14" role="presentation" focusable="false"><path d="M2 3.5h14M2 7h14M2 10.5h14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg></span>
            ...
            <div class="ai-workshop-grid">
              <button class="action-btn ${state.ui?.aiWorkshop?.activeTask === "free-text-risks" ? "active" : ""}" type="button" data-action="run-ai-workshop" data-ai-workshop-task="free-text-risks">Risiko aus Freitext erstellen</button>
              <button class="action-btn ${state.ui?.aiWorkshop?.activeTask === "measures-residual" ? "active" : ""}" type="button" data-action="run-ai-workshop" data-ai-workshop-task="measures-residual">Maßnahmen und Rest-Risiko ergänzen</button>
            </div>
            ...
            <div class="form-field" style="margin-top:12px;">
              ...
              <select id="aiWorkshopSelectedRisk" data-ai-workshop-field="selectedRiskId">
                <option value="">${state.ui?.aiWorkshop?.activeTask === "measures-residual" ? "Bestehendes Risiko wählen" : "Neues Risiko anlegen"}</option>
            ...
            <p class="form-note">${state.ui?.aiWorkshop?.activeTask === "measures-residual"
              ? "Wählst du ein bestehendes Risiko, werden Maßnahmen und qualitatives Rest-Risiko dort übernommen. Ein neues Risiko wird in diesem Modus nicht angelegt."
              : "Wählst du ein bestehendes Risiko, wird der Vorschlag dort übernommen. Standardmäßig ist Neues Risiko anlegen vorbelegt."}</p>
          ...
          <details class="info-card risk-register-card risk-fold-card risk-fold-edit" data-risk-panel-key="edit" style="order:${panelOrderIndex("edit")};" ${isPanelOpen("edit") ? "open" : ""}>
            <summary class="risk-fold-summary">
              <div class="risk-fold-summary-main">
                <div class="risk-fold-summary-topline">
                  <span class="risk-fold-drag-handle" data-risk-panel-drag-handle="true" draggable="true" aria-hidden="true"><svg viewBox="0 0 18 14" role="presentation" focusable="false"><path d="M2 3.5h14M2 7h14M2 10.5h14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg></span>
          ...
          <details class="info-card risk-register-card risk-fold-card risk-fold-table" data-risk-panel-key="table" style="order:${panelOrderIndex("table")};" ${isPanelOpen("table") ? "open" : ""}>
            <summary class="risk-fold-summary">
              <div class="risk-fold-summary-main">
                <div class="risk-fold-summary-topline">
                  <span class="risk-fold-drag-handle" data-risk-panel-drag-handle="true" draggable="true" aria-hidden="true"><svg viewBox="0 0 18 14" role="presentation" focusable="false"><path d="M2 3.5h14M2 7h14M2 10.5h14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg></span>
          ...
          <details class="info-card risk-register-card risk-fold-card risk-fold-chart" data-risk-panel-key="chart" style="order:${panelOrderIndex("chart")};" ${isPanelOpen("chart") ? "open" : ""}>
            <summary class="risk-fold-summary">
              <div class="risk-fold-summary-main">
                <div class="risk-fold-summary-topline">
                  <span class="risk-fold-drag-handle" data-risk-panel-drag-handle="true" draggable="true" aria-hidden="true"><svg viewBox="0 0 18 14" role="presentation" focusable="false"><path d="M2 3.5h14M2 7h14M2 10.5h14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg></span>
            ...
            <div class="risk-fold-body">
              <div class="risk-chart-toolbar">
                <div class="risk-chart-toggle">
                  <button class="risk-chart-chip ${topSortBy === "value" ? "" : "active"}" type="button" data-action="set-risk-register-sort" data-sort-by="priority">Priorität</button>
                  <button class="risk-chart-chip ${topSortBy === "value" ? "active" : ""}" type="button" data-action="set-risk-register-sort" data-sort-by="value">Risikowert</button>
                </div>
                <div class="risk-chart-toggle">
              ...
              <div class="risk-chart-list">
                ${topRisks.length ? topRisks.map((risk) => {
                  const riskTone = classifyRiskTone(risk);
                  const metric = topSortBy === "value" ? risk.expectedDamage : risk.qualitativeRiskValue;
                  const width = Math.max(12, Math.round((metric / topMetricMax) * 100));
                  const metricLabel = topSortBy === "value" ? formatCurrency(risk.expectedDamage) : `${risk.qualitativeRiskValue} von 25`;
                  return `
          ...
          <details class="info-card risk-register-card risk-fold-card risk-fold-matrix" data-risk-panel-key="matrix" style="order:${panelOrderIndex("matrix")};" ${isPanelOpen("matrix") ? "open" : ""}>
            <summary class="risk-fold-summary">
              <div class="risk-fold-summary-main">
                <div class="risk-fold-summary-topline">
                  <span class="risk-fold-drag-handle" data-risk-panel-drag-handle="true" draggable="true" aria-hidden="true"><svg viewBox="0 0 18 14" role="presentation" focusable="false"><path d="M2 3.5h14M2 7h14M2 10.5h14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg></span>
            ...
            <div class="risk-fold-body">
              ...
              <div class="risk-matrix-selected">
                <div class="risk-matrix-selected-head">
                  ...
                  <span>${matrixSelection ? `${selectedMatrixRisks.length === 1 ? "1 Risiko gefunden" : `${selectedMatrixRisks.length} Risiken gefunden`}` : "Klicke auf ein Feld, um die zugehörigen Risiken anzuzeigen."}</span>
                </div>
                ${matrixSelection ? (
