        ...
        <div class="module-shell risk-register-shell">
          ...
          <details class="info-card risk-fold-card ai-workshop-card" open style="margin-top:18px;">
            ...
            <div class="form-field wide">
                ...
                <textarea id="aiWorkshopFreeText" data-ai-workshop-field="freeText" placeholder="Beschreibe ein Risiko, eine Maßnahme oder einen Sachverhalt. Je ausführlicher du formulierst, desto besser kann die KI ein Ergebnis erstellen.">${escapeHtml(state.ui?.aiWorkshop?.freeText || "")}</textarea>
              </div>
            </div>
            ...
            <p class="form-note">Die KI wertet zuerst den Freitext aus und zeigt dir einen Vorschlag.<br>Danach entscheidest du, ob der Vorschlag als neues Risiko angelegt oder in ein bestehendes Risiko übernommen werden soll.</p>
